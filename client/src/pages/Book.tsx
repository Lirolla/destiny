...
const PDF_URLS: Record<AppLanguage, string> = {
  en: "https://dados.destinyhacking.com/pdfs/destiny-hacking-book.pdf",
  pt: "https://dados.destinyhacking.com/pdfs/destiny-hacking-book-pt.pdf",
  es: "https://dados.destinyhacking.com/pdfs/destiny-hacking-book.pdf", // ES PDF not yet available, fallback to EN
};
